...
<head>
    ...
    <title>Documentation - Hostel CRM</title>
...
<body class="bg-gray-50">
    <div class="min-h-screen flex">
        ...
        <div class="w-80 bg-white shadow-lg overflow-y-auto">
            ...
            <nav class="p-4">
                <div class="space-y-2">
                    <a href="/docs" class="block px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg {{ !$currentFile ? 'bg-blue-100 text-blue-700' : '' }}">
                        📚 Overview
                    </a>
