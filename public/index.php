<?php
/**
 * Hostel CRM - Landing Page
 *
 * A comprehensive Customer Relationship Management system for hostel management
 * Built with Laravel 12, featuring modern UI and complete functionality
 */

// Redirect to welcome page if not accessing root
