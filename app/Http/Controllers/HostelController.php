    ...
    public function index()
    {
        ...
        $hostels = Hostel::all()->map(function ($hostel) {
            return [
                ...
                'city' => $hostel->city,
                'state' => $hostel->state,
                'total_rooms' => $hostel->total_rooms, // Now calculated from actual rooms
                'total_beds' => $hostel->total_beds, // Now calculated from actual beds
                'rent_per_bed' => $hostel->rent_per_bed, // Now calculated from actual bed data
                'status' => $hostel->status,
                'manager_name' => $hostel->manager_name,
                'manager_phone' => $hostel->manager_phone,
                'manager_email' => $hostel->manager_email,
                'occupancy_rate' => $hostel->occupancy_rate, // Calculated from actual tenant data
